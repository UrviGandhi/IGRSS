<%@ page language="C#" masterpagefile="~/IGRSS_Default.master" autoeventwireup="true" inherits="Service_ServiceReport, App_Web_atprofjj" title="Untitled Page" stylesheettheme="IGRSS_Skin" %>
...
<table width="100%">
        <tr>
            <td colspan="4">
                <asp:Label ID="lblAppealReport" runat="server" SkinID="SubHeading" Text="Service Details" meta:resourcekey="lblAppealReportResource1"></asp:Label>
            </td>
        </tr>
        <tr>
