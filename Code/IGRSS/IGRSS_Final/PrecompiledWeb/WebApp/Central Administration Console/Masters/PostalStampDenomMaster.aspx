<%@ page language="C#" masterpagefile="~/IGRSS_Default.master" autoeventwireup="true" inherits="Inward_Outward_PostalStampDenomMaster, App_Web_qawyqul4" title="Untitled Page" stylesheettheme="IGRSS_Skin" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="Server">
	<asp:MultiView ID="mvPostalStamp" runat="server" ActiveViewIndex="1">
				...
				<tr>
					<td colspan="6">
						<asp:GridView ID="gvPostalDetails" runat="server" AutoGenerateColumns="False" DataKeyNames="StampDenomId"
							DataSourceID="odsGV" OnSelectedIndexChanged="gvPostalDetails_SelectedIndexChanged"
							OnRowDeleted="gvPostalDetails_RowDeleted">
							<Columns>
		...
		<asp:View ID="vieFv" runat="server">
				...
				<InsertItemTemplate>
					<table width="100%">
						...
						<tr>
							...
							<td class="validationColumn">
								<asp:RequiredFieldValidator ID="RfvDocumentNoIns" runat="server" ControlToValidate="txtAmountIns"
									ErrorMessage="Document No Can't be Blank">*</asp:RequiredFieldValidator>
							</td>
						</tr>
						<tr>
							<td class="labelColumn">
							...
							<td class="validationColumn">
								<asp:RequiredFieldValidator ID="rfvDetailsIns" runat="server" ControlToValidate="txtDetailsIns"
									ErrorMessage="Details Can't be Blank">*</asp:RequiredFieldValidator>
							</td>
						</tr>
						<tr>
							<td class="labelColumn">
			...
			<asp:ObjectDataSource ID="odsPostalStamp" runat="server" InsertMethod="AddPostalStampDenomDetails"
				OnUpdating="odsPostalStamp_Updating" SelectMethod="GetPostalStampDenomByStampDenomId"
				TypeName="IGRSS.BusinessLogicLayer.InwardOutward" UpdateMethod="UpdatePostalStampDenomDetails"
				DataObjectTypeName="IGRSS.BusinessObjects.FormViewParameter" OldValuesParameterFormatString="original_{0}">
				<UpdateParameters>
			...
			<asp:ObjectDataSource ID="odsGV" runat="server" SelectMethod="GetAllPostalStampDenomDetails"
				TypeName="IGRSS.BusinessLogicLayer.InwardOutward" DeleteMethod="DeleteStampDenomByStampDenomId">
			</asp:ObjectDataSource>
		</asp:View>
	</asp:MultiView>
</asp:Content>
