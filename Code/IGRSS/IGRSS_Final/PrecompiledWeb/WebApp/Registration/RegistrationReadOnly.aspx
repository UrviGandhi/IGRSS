<%@ page language="C#" masterpagefile="~/IGRSS_Default.master" autoeventwireup="true" inherits="Registration_UpdateRegistration, App_Web_rkvnn2am" title="Untitled Page" stylesheettheme="IGRSS_Skin" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="Server">
	<asp:MultiView ID="MvRegistration" runat="server" ActiveViewIndex="0">
		...
		<asp:View ID="View1" runat="server">
			<asp:FormView ID="FvRegistration" runat="server" DataKeyNames="RegistrationId"
				DataSourceID="odsRegistrationById" DefaultMode="Edit" OnDataBound="FvRegistration_DataBound"
				OnItemUpdating="FvRegistration_ItemUpdating">
				<EditItemTemplate>
					<table width="100%">
						<tr>
							<td colspan="6">
						...
						<tr>
							...
							<td class="textColumn">
								<asp:TextBox ID="txtFilePrefixUpd" runat="server" meta:resourcekey="txtFilePrefixUpd" Enabled="false"
						...
						<tr>
							...
							<td class="textColumn">
								<asp:CheckBox ID="ChkIsRentedUpd" runat="server" Checked='<%# Bind("IsRented") %>'  Enabled="false"
						...
						<tr>
							...
							<td class="textColumn">
								<asp:DropDownList ID="ddlFeeTypeUpd" runat="server" Enabled="false"   DataSourceID="odsFeeMaster" DataTextField="Name"
							...
							<td class="textColumn">
								<asp:TextBox ID="txtFeeAmountUpd" runat="server" meta:resourcekey="txtFeeAmountUpd" ReadOnly="true"
						...
						<tr>
							<td align="right" colspan="6">
								<asp:Button ID="btnUpdateFeeDetailUpd" runat="server" Text="Update" ValidationGroup="FeeDetails"
									Visible="false" />
								<asp:Button ID="btnAddFeeDetailUpd" runat="server" 
						...
						<tr>
							...
							<td colspan="6" style="width: 25%">
								<asp:TextBox ID="txtDocRemarksUpd" runat="server" meta:resourcekey="txtDocRemarksUpd" ReadOnly="true"
						...
						<tr>
							...
							<td>
								<asp:Button ID="btnAddDocumentUpd" runat="server" 
	...
	<asp:ObjectDataSource ID="odsOffices" runat="server" OldValuesParameterFormatString="original_{0}"
		SelectMethod="GetOfficesDetails" TypeName="IGRSS.BusinessLogicLayer.Administration.OfficeManagementMaster" UpdateMethod="UpdateOfficeDetails">
		<UpdateParameters>
			<asp:Parameter Name="Parameter" Type="Object" />
	...
	<br />
	<asp:ObjectDataSource ID="odsSearchByfileSlNo" runat="server"
		OldValuesParameterFormatString="original_{0}" SelectMethod="GetInputSheetDetailsByFileSlNo"
	...
	<asp:ObjectDataSource ID="odsValuationForm" runat="server"
		SelectMethod="GetValuationFormDetailsByRegistrationId" TypeName="IGRSS.BusinessLogicLayer.Registration"
		UpdateMethod="UpdateValuationFormDetails" OnUpdating="odsValuationForm_Updating" InsertMethod="AddNewRegistrationDocumentDetails">
		<SelectParameters>
			<asp:ControlParameter ControlID="GvRegistrationDetails" Name="RegistrationId" PropertyName="SelectedValue"
				Type="Object" />
		</SelectParameters>
