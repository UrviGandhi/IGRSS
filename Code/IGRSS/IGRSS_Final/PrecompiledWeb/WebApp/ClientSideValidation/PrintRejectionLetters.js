...
//Common
//FileName      - PrintRejectionLetters.js
//Purpose       - Javascript function which is used to validate the Checkbox in PrintREjectionLetters.js
//Author        : G.Anil Kumar.
//Creation Date : 15-July-2006
...
/****************************************************************************************/
var Err001='\t\t\t\t\t\t\t\tPlease Select At Least One Record to Generate Report.';
var Err002='\t\t\t\t\t\t\t\tDate is Mandatory.';
var Err000='Report Generation Fail.';
	...
	function CheckAll(checkAllBox)
     ...
     function ValidateDateTextbox()
     {
		var Errshortmsg=Err000;
         //Variable to store Long Message.
         var ErrLongmsg="";
        if(true==IstxtEmpty('txtDate'))
        {
			if(""==ErrLongmsg)
			{
				ErrLongmsg=Err000;
