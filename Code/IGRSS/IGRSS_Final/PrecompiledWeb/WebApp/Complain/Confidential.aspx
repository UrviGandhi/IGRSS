<%@ page language="C#" masterpagefile="~/IGRSS_Default.master" autoeventwireup="true" inherits="Complain_Confidential, App_Web_jp5ccvwi" title="Confidential Details" culture="auto" uiculture="auto" meta:resourcekey="PageResource1" stylesheettheme="IGRSS_Skin" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="Server">
    ...
    <asp:ObjectDataSource ID="odsComplain" runat="server" SelectMethod="GetComplainDetailsByComplainId"
        TypeName="IGRSS.BusinessLogicLayer.Complain" InsertMethod="AddNewConfidentialreport" UpdateMethod="UpdateComplainDetails"
        OnInserting="odsComplain_Inserting" OnUpdating="odsComplain_Updating" OnInserted="odsComplain_Inserted" OldValuesParameterFormatString="original_{0}">
        <SelectParameters>
