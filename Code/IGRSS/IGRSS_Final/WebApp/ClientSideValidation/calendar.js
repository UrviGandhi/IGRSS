...
Calendar.prototype.getMonthlyCalendarCode = function() {
	...
	vCode += ("<TABLE WIDTH='60%' BORDER=1 class=calbody rules=all BGCOLOR=\"" + this.gBGColor + "\" style='font-size:" + fontsize + "pt;'>");
...
Calendar.prototype.show = function() {
	...
	ggWinContent += ("<FONT FACE='" + fontface + "' size=2pt><b>");
	...
	ggWinContent += ("<TABLE WIDTH='60%' class=calheader BORDER=1 rules=all CELLSPACING=0 CELLPADDING=1 BGCOLOR='#e0e0e0' style='font-size:" + fontsize + "pt;'><TR><TD ALIGN=center>");
	ggWinContent += ("<span " +
		"onClick=\"Build(" + 
		"'" + this.gReturnItem + "', '" + this.gMonth + "', '" + (parseInt(this.gYear)-1) + "', '" + this.gFormat + "'" +
		");" +
		"\"><-Year<\/span></TD><TD ALIGN=center>");
	ggWinContent += ("<span " +
...
Calendar.prototype.cal_data = function() {
	...
	*/
	...
	for (i=0; i<vFirstDay; i++) {
		vCode = vCode + "<TD style='cursor:default' align='center' WIDTH='14%'" + this.write_weekend_string(i) + "><FONT FACE='" + fontface + "'> </FONT></TD>";
	}
	...
	for (j=vFirstDay; j<7; j++) {
		vCode = vCode + "<TD align='center' WIDTH='14%'" + this.write_weekend_string(j) + "><FONT FACE='" + fontface + "'>" + 
			...
			"<A HREF='javascript:void(0);' " + 
				...
				"onMouseOut=\"window.status=' '; return true;\" " +
				"onClick=\"document.all('" + this.gReturnItem + "').value='" + 
	...
	for (m=1; m<(7-j); m++) {
		if (this.gYearly)
			vCode = vCode + "<TD style='cursor:default' align='center' WIDTH='14%'" + this.write_weekend_string(j+m) + 
...
document.all(calContainer).innerHTML = ggWinContent
}
...
function show_calendar() {
	...
	*/
	...
	if (arguments[1] == null || arguments[1] == ""){
		alert('Container for Calendar Not passed in function call');
		return false;
	}
	else if (! document.all(arguments[1])){
		alert('Container for Calendar Not Defined Properly');
		return false;
	}
	else if (document.all(arguments[1]).tagName != 'SPAN'){
		alert('Container for Calendar should be a "<span>" tag');
		return false;
	}
	else{
		calContainer = arguments[1]
	}
